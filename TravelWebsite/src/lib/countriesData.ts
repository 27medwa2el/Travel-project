export const globalCountries = [
  ...
  { name: "Czechia (Czech Republic)", code: "CZ", continent: "Europe" },
  ...
  { name: "Holy See", code: "VA", continent: "Europe" },
  ...
  { name: "Myanmar (formerly Burma)", code: "MM", continent: "Asia" },
  ...
  { name: "Palestine State", code: "PS", continent: "Asia" },
